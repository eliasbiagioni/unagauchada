...
<body>
    ...
    <div class="barraInicial longitud">
        <div class="bienvenido">
            ...
            <?php if ($propio == 1) {?>
                ...
                <?php if($this->session->userdata('es_administrador') == 0) { ?>
    ...
    <div class="contenedorDetallePerfil">
    <?php
        if ($propio ==1) {
            ?> <h1 class="centrarh1"> Perfil propio </h1><?php
        }
        else {
            echo "<h1 class='centrarh1'> Perfil de $usuario->nombre_usuario</h1>";
        }
    ...
    <div class="imagenPerfil"><img src="<?= $source_imagen ?>" width="400px" height="350px" alt=""/></div>
